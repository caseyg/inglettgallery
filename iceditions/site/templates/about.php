...
<div class="row">
  ...
  <section class="col-md-4">
    ...
    <a href="mailto:<?php echo $pages->find('about')->email()->html() ?>"><?php echo $pages->find('about')->email()->html() ?></a></p>

    <p>
      <a href="<?php echo $page->map_link() ?>" class="d-inline-block m-b-1 m-t-2"><i class="fa fa-map-pin" aria-hidden="true"></i> View Map</a><br>
      <a href="http://inglettgallery.com/mailing-list"><i class="fa fa-envelope-o" aria-hidden="true"></i> Join Our Mailing List</a>
    </p>
  </section>
