...
<div class="row">
  ...
  <?php
  $represented = $page->children()->visible()->filterBy('Status', 'represented')->sortBy('last_name', 'asc');
  $exhibited = $page->children()->visible()->filterBy('Status', 'exhibited')->sortBy('last_name', 'asc');
  ?>
